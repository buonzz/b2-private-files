<div class="wrap">
    <h1 class="wp-heading-inline">Short Codes for file <?php echo wp_kses($fileName, []);?></h1>
    ...
    <div class="form-wrap">
        <div class="form-field term-description-wrap">
                ...
                <textarea name="description" rows="1" cols="40">[b2-private-file-button filename="<?php echo wp_kses($fileName, []);?>"]</textarea>
