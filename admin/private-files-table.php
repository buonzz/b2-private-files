...
class PrivateFiles_List_Table extends WP_List_Table {
    ...
    function get_sortable_columns() {
        $sortable_columns = array(
            ...
            'uploadTimestamp'  => array('uploadTimestamp',false)
        );
    ...
    function prepare_items() {
         ...
         */
        $data = B2_Private_Files_B2_Library::fetch_files_array();
